// @ts-nocheck
/* ──────────────────────────────────────────────────────────
   SVG art generators — extracted from js/app.js
   Procedural scene + character illustrations (shared visual
   language between the web app and the Remotion video).
   ────────────────────────────────────────────────────────── */
...
export { CHARS, charArt, sceneArt, seededRand };